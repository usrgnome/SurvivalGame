...
export default function earcut(data: any, holeIndices?: any, dim?: any) {
...
function splitEarcut(start: number, triangles: number, dim: number, minX: number, minY: number, invSize: number) {
...
function splitPolygon(a: any, b: any) {
    var a2 = new (Node as any)(a.i, a.x, a.y),
        b2 = new (Node as any)(b.i, b.x, b.y),
        an = a.next,
        bp = b.prev;
...
function Node(i: any, x: any, y: any) {
...
earcut.deviation = function (data: any, holeIndices: any, dim: any, triangles: any) {
    var hasHoles = holeIndices && holeIndices.length;
...
earcut.flatten = function (data: any) {
    var dim = data[0][0].length,
        result: any = {vertices: [], holes: [], dimensions: dim},
        holeIndex = 0;

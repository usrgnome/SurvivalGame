...
export const Sprites: any = {
  ...
  [SPRITE.SWORD]: itemAtlas.frame("sword_stone", new mPoint(0.1, 0.5), new mPoint(0.4, 0.4)),
  [SPRITE.SPEAR]: itemAtlas.frame("spear_amethyst", new mPoint(0.1, 0.5), halfScale),

...
import { C_AttackTimer, C_Body, C_ClientHandle, C_Controls, C_Health, C_HitBouceEffect, C_Hunger, C_Leaderboard, C_Mob, C_Mouse, C_Position, C_Temperature, C_TerrainInfo } from './Components';
...
export const temperatureQuery = defineQuery([C_Temperature, C_Health, C_TerrainInfo]);
